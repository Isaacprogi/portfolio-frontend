    ...
    <div key={item.id} className='flex flex-col group items-center text-center'>
      ...
      <div className='mb-8 hover:opacity-[.8] relative duration-300 cursor-pointer'>
        <a
          ...
          className='text-center opacity-[0] text-accent z-[300] group-hover:opacity-[.5] flex items-center cursor-pointer justify-center text-lg font-[700] absolute w-full h-full bg-black transition-opacity duration-300'
        ></a>
