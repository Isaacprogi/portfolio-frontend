          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-700 dark:text-gray-300">isaac@example.com</span>
              </div>
              <div className="flex items-center gap-4">
                <Linkedin className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                <span className="text-gray-700 dark:text-gray-300">linkedin.com/in/isaac</span>
              </div>
              <div className="flex items-center gap-4">
                <Github className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                <span className="text-gray-700 dark:text-gray-300">github.com/isaac</span>
              </div>
            </div>
          </div>
